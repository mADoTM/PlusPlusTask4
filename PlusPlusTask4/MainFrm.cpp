...
// MainFrm.cpp: реализация класса MainWindow
//
...
IMPLEMENT_DYNAMIC(MainWindow, CMDIFrameWndEx)
...
BEGIN_MESSAGE_MAP(MainWindow, CMDIFrameWndEx)
	ON_WM_CREATE()
	ON_COMMAND(ID_WINDOW_MANAGER, &MainWindow::OnWindowManager)
	ON_COMMAND(ID_VIEW_CUSTOMIZE, &MainWindow::OnViewCustomize)
	ON_REGISTERED_MESSAGE(AFX_WM_CREATETOOLBAR, &MainWindow::OnToolbarCreateNew)
	ON_COMMAND_RANGE(ID_VIEW_APPLOOK_WIN_2000, ID_VIEW_APPLOOK_WINDOWS_7, &MainWindow::OnApplicationLook)
	ON_UPDATE_COMMAND_UI_RANGE(ID_VIEW_APPLOOK_WIN_2000, ID_VIEW_APPLOOK_WINDOWS_7, &MainWindow::OnUpdateApplicationLook)
	ON_WM_SETTINGCHANGE()
END_MESSAGE_MAP()
...
// Создание или уничтожение MainWindow
...
BOOL MainWindow::CreateDockingWindows()
{
	BOOL bNameValid;
	// Создать окно вывода
...
void MainWindow::SetDockingWindowIcons(BOOL bHiColorIcons)
{
...
// Обработчики сообщений MainWindow

void MainWindow::OnWindowManager()
{
	ShowWindowsDialog();
}

void MainWindow::OnViewCustomize()
{
...
LRESULT MainWindow::OnToolbarCreateNew(WPARAM wp,LPARAM lp)
{
...
void MainWindow::OnApplicationLook(UINT id)
{
	CWaitCursor wait;
...
void MainWindow::OnUpdateApplicationLook(CCmdUI* pCmdUI)
{
	pCmdUI->SetRadio(theApp.m_nAppLook == pCmdUI->m_nID);
}


BOOL MainWindow::LoadFrame(UINT nIDResource, DWORD dwDefaultStyle, CWnd* pParentWnd, CCreateContext* pContext)
{
